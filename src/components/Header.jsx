...
function Header(){
    return <div className="header_section">
                    ...
                    <a className="_mobile_logo"><img src="https://cdns.iconmonstr.com/wp-content/assets/preview/2012/240/iconmonstr-behance-1.png" /></a>
                    <i class="fas fa-search"></i>
                    <a className="use_app">Use App</a>
                    </div>
                <label for="bur"><i class="fas cl fa-times"></i></label>
                <input className="check" type="checkbox" id="bur" />
                <div id="box">
                <i class="fas fa-times"></i>
                <ul>
                    <li><a href="#" className="logo">Behance</a></li>
                    <li><a href="#">Discover</a></li>
                    <li><a href="#">Livestreams</a></li>
                    <li><a href="#">Jobs</a></li>
                </ul>
                <div className="header_search">
                <i class="des_search fas fa-search"></i>
                    <input type="text" placeholder="Search..." />
                </div>
                <div className="download_section">
                   <div className="apple_store">
                   <a><img src="https://johnlewis.scene7.com/is/image/JohnLewis/download-apple-icon" /></a>
                   </div>

                   <div className="play_store">
                   <a><img  src="https://applelaneanimalhospital.com/wp-content/uploads/2019/04/google.png" /></a>
                   </div>
                </div>
